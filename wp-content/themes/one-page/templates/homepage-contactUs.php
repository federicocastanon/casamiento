                        ...
                        <div class="contact_content">
                            ...
                            <form class="contactform" action="#" method="post">
                                <div class="form-group">
                                    <input class="form-control text animated fade_in_up" type="text" name="contactName" value="" placeholder="<?php echo _e('Nombre', 'one-page'); ?>" style="animation-delay: .2s;<?php echo 'border-color:' . onepage_get_option('onepage_contact_input_box_border_color', '#6b8cca'); ?>" required/>
                                    <?php if ($nameError != '') { ?>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control message animated fade_in_up" type="textarea" name="msg" placeholder="<?php echo _e('Dejanos un mensaje ya que estás', 'one-page'); ?>" style="animation-delay: .4s;<?php echo 'border-color:' . onepage_get_option('onepage_contact_input_box_border_color', '#6b8cca'); ?>" required></textarea>
                                    <?php if ($msgError != '') { ?>
                                        <span class="error"> <?php echo $msgError; ?> </span>
                                    <?php } ?>
                                </div>
                                <div class="clear"></div>
                                <input  class="btnSubmit animated fade_in_up" type="submit" name="submitted" value="<?php echo esc_attr(onepage_get_option('onepage_contact_send_button_text', __('CONFIRMAR', 'one-page'))); ?>" style="animation-delay: .2s;"/>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-7">

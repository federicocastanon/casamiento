							...
							<div class="sl-slide-inner">
								...
								<div class="slider_caption_wrapper">
									<div class="slider_caption">
										<h2>Casamiento y fiesta</h2>
										<div class="slider_sep"></div>
										<p>Falta poco para que nos acompañen</p>
										<span><?php
echo do_shortcode('[tminus t="03-12-2016 23:59:59" omitweeks="true" days="días" hours="horas" minutes="minutos" seconds="segundos" style="carbonlite"  /]');
?></span>
									</div>
								</div>
